...
# --- Execution ---
weights_data = np.load('homeostat_IE/MFGoGr_IE_shuffleMF50_noCS_noGoGo_yesgrGo_GOplast_1000_trial/MFGoGr_IE_shuffleMF50_noCS_noGoGo_yesgrGo_GOplast_1000_trial_GoThr.npy')
plot_save_path = "/home/aw39625/minisim/Results/MFGoGr_IE_shuffleMF50_noCS_noGoGo_yesgrGo_GOplast_1000_trial/GoThr.png"

# Plotting MFGO (Type 3)
plotThresholdContinuous(weights_data, save_path=plot_save_path, thr_type=1)