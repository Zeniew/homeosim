...
if __name__ == "__main__":
    # run_experiment(
    #         expName='MFGoGr_SS_shuffleMF10percent_noCS_gogoplast_1000_trial',
    #         numTrial=1000,
    #         useCS=0,
    #         MFGO_PLAST=0,
    #         GOGO_PLAST=1,
    ...
    run_experiment(
        expName='MFGoGr_SS_shuffleMF10percent_noCS_mfgoplast_1000_trial',
        numTrial=1000,
        useCS=0,
        MFGO_PLAST=1,
        GOGO_PLAST=0,
    ...
    run_experiment(
        expName='MFGoGr_SS_shuffleMF10percent_noCS_mfgrplast_1000_trial',
        numTrial=1000,
        useCS=0,
        MFGO_PLAST=0,
        GOGO_PLAST=0,
    ...
    run_experiment(
        expName='MFGoGr_SS_shuffleMF10percent_noCS_gogrplast_1000_trial',
        numTrial=1000,
        useCS=0,
        MFGO_PLAST=0,
        GOGO_PLAST=0,
    ...
    run_experiment(
        expName='MFGoGr_SS_shuffleMF10percent_noCS_allGOplast_1000_trial',
        numTrial=1000,
        useCS=0,
        MFGO_PLAST=1,
        GOGO_PLAST=1,
    ...
    run_experiment(
        expName='MFGoGr_SS_shuffleMF10percent_noCS_allGRplast_1000_trial',
        numTrial=1000,
        useCS=0,
        MFGO_PLAST=0,
        GOGO_PLAST=0,
