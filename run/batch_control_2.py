...
def run_session(filepath_m, filepath_go, filepath_gr, filepath_w_grgo, filepath_w_gogo,
    ...
    GOGO_importPath = "/home/data/einez/connect_arr/R00_C12_PRE.gogo"
...
if __name__ == "__main__":
    # run_experiment(
    #         expName='0recip_MFGoGr_SS_shuffleMF10percent_noCS_gogoplast_1000_trial',
    #         numTrial=1000,
    #         useCS=0,
    #         MFGO_PLAST=0,
    #         GOGO_PLAST=1,
    ...
    # run_experiment(
    #     expName='0recip_MFGoGr_SS_shuffleMF10percent_noCS_mfgoplast_1000_trial',
    #     numTrial=1000,
    #     useCS=0,
    #     MFGO_PLAST=1,
    #     GOGO_PLAST=0,
    ...
    # run_experiment(
    #     expName='0recip_MFGoGr_SS_shuffleMF10percent_noCS_mfgrplast_1000_trial',
    #     numTrial=1000,
    #     useCS=0,
    #     MFGO_PLAST=0,
    #     GOGO_PLAST=0,
    ...
    # run_experiment(
    #     expName='0recip_MFGoGr_SS_shuffleMF10percent_noCS_gogrplast_1000_trial',
    #     numTrial=1000,
    #     useCS=0,
    #     MFGO_PLAST=0,
    #     GOGO_PLAST=0,
    ...
    run_experiment(
        expName='0recip_MFGoGr_SS_shuffleMF10percent_noCS_allGOplast_1000_trial',
        numTrial=1000,
        useCS=0,
        MFGO_PLAST=1,
        GOGO_PLAST=1,
    ...
    run_experiment(
        expName='0recip_MFGoGr_SS_shuffleMF10percent_noCS_allGRplast_1000_trial',
        numTrial=1000,
        useCS=0,
        MFGO_PLAST=0,
        GOGO_PLAST=0,
